...
<html lang="en">
   ...
   <body class="clinic_version">
               ...
               <div class="col-md-12 col-sm-12">
                  <div class="text-contant">
                     <h2>
                        ...
                        <a href="" class="typewrite" data-period="2000" data-type='[ "Welcome to Life Line", "We Care Your Health", "We are Expert!" ]'>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
               <div class="row">
                  <div class="service-time one" style="background:#2895f1;">
                     ...
                     <p>For emergency services, call our tollfree number :800-446-2279 (toll-free).</p>
                     <p>We provide the best customer services all over the world</p>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
               <div class="row">
                  <div class="service-time three" style="background:#0060b1;">
                     ...
                     <h3>Online Appointment In your nearby hospital</h3>
                     
                        <p>Our goal is to provide a hazzle free and easy to use appointment system in your near by hospital.</p>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div id="about" class="section wow fadeIn">
         <div class="container">
            <div class="heading">
               ...
               <h2>The Specialist Hospital near you!</h2>
            </div>
            <!-- end title -->
            <div class="row">
               <div class="col-md-6">
                  <div class="message-box">
                     ...
                     <p>Getting an accurate diagnosis can be one of the most impactful experiences that you can have — especially if you've been in search of that answer for a while. We can help you get there.
                        Find out moreabout getting accurate answers</p>
                     <a href="more.php" data-scroll class="btn btn-light btn-radius btn-brd grd1 effect-1">Learn More</a>
                  </div>
                  <!-- end messagebox -->
               </div>
               <!-- end col -->
            ...
            <div class="row">
               ...
               <div >
                <br>
                <a href="faq/faq.php" data-scroll class="btn btn-light btn-radius btn-brd grd1 effect-1">More Info about COVID-19</a>
               </div>
               </div>
            <!-- end row -->
         </div>
	  ...
	  <div id="doctors" class="parallax section db" data-stellar-background-ratio="0.4" style="background:#fff;" data-scroll-id="doctors" tabindex="-1">
		...
		<div class="heading">
               <span class="icon-logo"><img src="images/icon-logo.png" alt="#"></span>
               <h2>The Specialist Hospitals</h2>
            </div>

            <div class="row dev-list text-center">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeIn;">
                    <div class="widget clearfix">
                        <img src="images/pushpagiri.jpg" alt="" class="img-responsive img-rounded">
                        <div class="widget-title">
                            <h3>Pushpagiri Hospital</h3>
                           
                        </div>
                        <!-- end title -->
                        <p>Pushpagiri Medical College Hospital is located in Thiruvalla, kottayam, Kerala.</p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.4s; animation-name: fadeIn;">
                    <div class="widget clearfix">
                        <img src="images/mar.jpg" alt="" class="img-responsive img-rounded">
                        <div class="widget-title">
                            <h3>Mar sleeva Medicity</h3>
                           
                        </div>
                        <!-- end title -->
                        <p>Mar sleeva Medicity is located in Pala, Kottayam, Kerala</p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn">
                    <div class="widget clearfix">
                        <img src="images/ktm.jpg" alt="" class="img-responsive img-rounded">
                        <div class="widget-title">
                            <h3>Govt. MCH Kottayam</h3>
                            
                        </div>
                        <!-- end title -->
                        <p>Government Medical College Hospital is located in Athirampuzha, Kottayam, Kerala</p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn">
                    <div class="widget clearfix">
                        <img src="images/tri.jpg" alt="" class="img-responsive img-rounded">
                        <div class="widget-title">
                            <h3>Govt. MCH Thrissur</h3>
                           
                        </div>
                        <!-- end title -->
                        <p>Government Medical College Thrissur Hospital is located in M.G Kavu, Thrissur, Kerala</p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn">
                    <div class="widget clearfix">
                        ...
                        <!-- end title -->
                        <p>Government Medical College Hospital is located in Vandanam, Alapuzha, Kerala</p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn">
                    <div class="widget clearfix">
                        <img src="images/tvm.jpg" alt="" class="img-responsive img-rounded">
                        <div class="widget-title">
                            <h3>Govt. MCH Trivandrum</h3>
                            
                        </div>
                        <!-- end title -->
                        <p>Government Medical College Hospital is located in Chalakuzhi, Trivandrum, Kerala</p>
           ...
           <div >
               <br>
                <a href="dept/dept.php" data-scroll class="btn btn-light btn-radius btn-brd grd1 effect-1">Find More Hospitals</a>
            </div>
            </div><!-- end container -->
            ...
            <div class="row">
               <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                  <div class="inner-services">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" >                         
                     <div class="serv">                      
                      <a href="reservation.php" data-scroll class="btn btn-light btn-radius btn-brd grd1 effect-1">Book Now</a>                     
                      </div>                 
                   </div>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="logo padding">
                     ...
                     <p>Its not just for saving lives, but also making their lives better.</p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="footer-info padding">
                     <h3>CONTACT US</h3>
                     <p><i class="fa fa-map-marker" aria-hidden="true"></i>Varikkasseri Mana - Varikkasseri Mana Road, Manisseri P O, Ottappalam, Kerala, India. PIN:679521</p>
                     <p><i class="fa fa-paper-plane" aria-hidden="true"></i> info@lifeline.com</p>
                     <p><i class="fa fa-phone" aria-hidden="true"></i> +914828-224042</p>
                  </div>
               </div>
               <div class="col-md-4">

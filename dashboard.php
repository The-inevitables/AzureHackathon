               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        <li><a class="active" href="index.php">Feeds</a></li>
                        <li><a data-scroll href="#about">Reservation Status</a></li>
                        <li><a data-scroll href="#service">Important Dates</a></li>
                        <li><a data-scroll href="#doctors">In-Patient Status</a></li>

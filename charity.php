      ...
      <div class="col-lg-16 col-md-15 col-sm-19 col-xs-15">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <input type="text" id="firstName" name="userID" placeholder="First Name"  />
				 ...
				 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <div class="center"> <a href="https://www.instamojo.com/@akhilmanil0" class=" header-title mb-3"><h3>Donate Securely</h3></a></div>

   ...
   <body class="clinic_version">
      ...
      <div class="col-lg-16 col-md-15 col-sm-19 col-xs-15">
                  ...
                  <div class="appointment-form">
                     <h3><span></span>Provide your Feedback on LifeLine</h3>
                     <div class="form">
                        <form method="post" action="sample/patient.php">
                          ...
                          <label for="lname">Last Name</label>
                             ...
                             <div>
                          <label for="country">Country &nbsp &nbsp &nbsp</label>
							...
							&nbsp
                              ...
                              <option value="IND">India</option>
                                 <option value="CAN">Canada</option>
									...
									<option value="usa">Amsterdam</option>
									<option value="usa">Others
									</option>
                            </select>
                                 </div>
                           <div>
                          <label for="subject">Feedback</label>
                            <textarea id="Feedback" name="Feedback" placeholder="What do you think ?..." style="height:200px"></textarea>
                           </div>
